...
generate_html_document_yml <- function(output_dir) {
  ...
  # Build full paths to section files
  header_path <- file.path(output_dir, "index_header.html")
  prefix_path <- file.path(output_dir, "index_prefix.html")
  postfix_path <- file.path(output_dir, "index_postfix.html")
  ...
  yaml_content <- sprintf(
    ...
    html_document:
      ...
      lib_dir: libs",
    header_path, prefix_path, postfix_path
  )
  writeLines(yaml_content, file.path(output_dir, "html_document.yml"))
}
