...
- [`cached_lookup_result()`](http://codecheck.org.uk/codecheck/reference/cached_lookup_result.md)
  :
...
- [`cert_link_cache`](http://codecheck.org.uk/codecheck/reference/cert_link_cache.md)
  : In-session cache of resolved certificate download links, see
  get_cert_link()
...
- [`check_register_researchequals_policy()`](http://codecheck.org.uk/codecheck/reference/check_register_researchequals_policy.md)
  : Check a register's ResearchEquals certificates against the CODECHECK
  curation policy
...
- [`check_researchequals_record()`](http://codecheck.org.uk/codecheck/reference/check_researchequals_record.md)
  : Audit a ResearchEquals certificate against the CODECHECK curation
  policy
...
- [`classify_poppler_log()`](http://codecheck.org.uk/codecheck/reference/classify_poppler_log.md)
  : Poppler (via pdftools) reports PDF parsing problems by printing "PDF
  error: ..." lines directly to R's message connection rather than
  raising a condition on them, so they bypass ordinary error handling
  and, uncaptured, flood the console - one line per malformed glyph or
  object, sometimes hundreds per certificate. This splits captured
  poppler output into messages that mean the PDF is genuinely broken
  (unparsable, not really a PDF) versus cosmetic rendering quirks that
  poppler recovers from on its own (e.g. malformed embedded fonts) and
  that don't affect the resulting page images.

- [`clear_cert_link_cache()`](http://codecheck.org.uk/codecheck/reference/clear_cert_link_cache.md)
  : Clear the in-session cache of resolved certificate download links

- [`clear_researchequals_policy_cache()`](http://codecheck.org.uk/codecheck/reference/clear_researchequals_policy_cache.md)
...
- [`convert_cert_pdf_to_png()`](http://codecheck.org.uk/codecheck/reference/convert_cert_pdf_to_png.md)
  : Converts each page of a certificate PDF to PNG images, saving them
  in the specified certificate directory.
...
- [`get_abstract_result()`](http://codecheck.org.uk/codecheck/reference/get_abstract_result.md)
...
- [`get_abstract_text_crossref_result()`](http://codecheck.org.uk/codecheck/reference/get_abstract_text_crossref_result.md)
...
- [`get_cert_link_uncached()`](http://codecheck.org.uk/codecheck/reference/get_cert_link_uncached.md)
  : Resolves the download link for a certificate file without caching,
  see get_cert_link().
...
- [`get_openalex_id_result()`](http://codecheck.org.uk/codecheck/reference/get_openalex_id_result.md)
  : Look up the OpenAlex work ID and report whether the answer is
  conclusive
...
- [`get_researchequals_collection()`](http://codecheck.org.uk/codecheck/reference/get_researchequals_collection.md)
  : Retrieve a collection on ResearchEquals

- [`get_researchequals_collections()`](http://codecheck.org.uk/codecheck/reference/get_researchequals_collections.md)
  : Retrieve the collections a certificate must be part of

- [`get_researchequals_version_metadata()`](http://codecheck.org.uk/codecheck/reference/get_researchequals_version_metadata.md)
...
- [`openalex_api_key()`](http://codecheck.org.uk/codecheck/reference/openalex_api_key.md)
...
- [`render_register_full()`](http://codecheck.org.uk/codecheck/reference/render_register_full.md)
...
- [`report_researchequals_policy_findings()`](http://codecheck.org.uk/codecheck/reference/report_researchequals_policy_findings.md)
...
- [`resolve_researchequals_version_id()`](http://codecheck.org.uk/codecheck/reference/resolve_researchequals_version_id.md)
...
- [`split_github_repo_spec()`](http://codecheck.org.uk/codecheck/reference/split_github_repo_spec.md)
